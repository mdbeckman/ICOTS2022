...
- **RQ3**: ¿Qué tipo de representación de NLP conduce a un buen rendimiento de agrupación y cómo interactúa eso con el algoritmo de clasificación?

### *¡¿Spoilers?!*
- RQ1: acuerdo sustancial entre evaluadores e intraevaluadores
- RQ2: acuerdo sustancial entre el etiquetado humano y NLP
